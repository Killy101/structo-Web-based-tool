...
class SpanishPatternGenerator(PatternGeneratorBase):
    ...
    SPANISH_PATH_TRANSFORM_CLEANUP: dict[str, list[list]] = {
        ...
        "7":  [["\\([0-9]+\\) ", "", 0, ""], ["BIS", "Bis", 0, ""], ["\\.—$", "", 0, ""]],
        "9":  [["Artículo", "Art.", 0, ""], ["\\([0-9]+\\) ", "", 0, ""], ["\\.-$", "", 0, ""], ["o", "", 0, ""], ["º", "", 0, ""], ["°", "", 0, ""], ["º.-$", "", 0, ""], ["\\.$", "", 0, ""]],
        "10": [["\\([0-9]+\\) ", "", 0, ""], ["\\.-$", "", 0, ""], ["\\.$", "", 0, ""]],
        "11": [["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "12": [["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "13": [["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "14": [["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "15": [["\\([0-9]+\\) ", "", 0, ""], ["\\([0-9]+\\)", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "17": [["TRANSITORIOS", "Transitorios", 0, ""], ["TRANSITORIO", "Transitorio", 0, ""], ["TRANSITORIA", "Transitoria", 0, ""], ["TRANSITORIAS", "Transitorias", 0, ""], ["CONSIDERANDO", "Considerando", 0, ""], ["REFERENCIAS", "Referencias", 0, ""], ["\\([0-9]+\\) ", "", 0, ""], ["ANEXO", "Anexo", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "18": [["ÚNICO", "Único", 0, ""], ["PRIMERA", "Primera", 0, ""], ["SEGUNDA", "Segunda", 0, ""], ["TERCERA", "Tercera", 0, ""], ["CUARTA", "Cuarta", 0, ""], ["QUINTA", "Quinta", 0, ""], ["SEXTA", "Sexta", 0, ""], ["UNICA", "Unica", 0, ""], ["PRIMERO", "Primero", 0, ""], ["SEGUNDO", "Segundo", 0, ""], ["TERCERO", "Tercero", 0, ""], ["CUARTO", "Cuarto", 0, ""], ["ÚNICA", "Única", 0, ""], ["UNICO", "Unico", 0, ""], ["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.-$", "", 0, ""], ["\\. -$", "", 0, ""], ["\\.$", "", 0, ""]],
        "19": [["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
        "20": [["\\([0-9]+\\) ", "", 0, ""], ["\\)$", "", 0, ""], ["\\.$", "", 0, ""]],
    }
