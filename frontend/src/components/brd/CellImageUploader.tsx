                ...
                <div key={img.id} className="rounded-lg overflow-hidden border border-slate-200 dark:border-[#2a3147] bg-slate-50 dark:bg-[#161b2e]">
                  ...
                  <div className="flex items-center justify-between px-2 py-1 border-t border-slate-100 dark:border-[#2a3147]">
                    ...
                    <button
                      ...
                      className="flex-shrink-0 inline-flex items-center gap-1 px-2 py-0.5 rounded text-[9px] font-semibold bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/20 border border-red-200 dark:border-red-700/30 disabled:opacity-40 transition-all"
                    >
                      {deleting === img.id
                        ...
                        : <><svg className="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>Delete</>
                      }
                    </button>
                  </div>
                </div>
