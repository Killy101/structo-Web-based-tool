...
router.use("/", exportBrd);  // GET    /brd/:brdId/export/csv|pdf-html
router.use("/", crud);       // GET    /brd, GET /brd/:brdId, DELETE, PATCH, POST /:brdId/restore
